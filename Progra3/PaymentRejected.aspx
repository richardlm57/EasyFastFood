   ...
   <table class="auto-style5">
       <tr>
           <td style="background-color: #af3a11; text-align: center;" >
               <asp:Label ID="Label1" runat="server" Text="ERROR AL REALIZAR SU PAGO, FAVOR CONFIRME SU SALDO"  Font-Size="Large" Font-Names="Kristen ITC,X-Large" ForeColor="White"></asp:Label>
               <br />
               <br />
